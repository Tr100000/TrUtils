...
public interface ImplementedInventory extends Container {
    ...
    /**
     * Returns the index of the first stack with the provided item.
     * @param item The item to check for.
     * @return The index of the first stack with the provided item, -1 if none is found.
     */
    default int firstIndexOf(Item item) {
